...
In Postman, click the 'Import' button, click Import from link, edit the url 'https://raw.githubusercontent.com/gost/workshops/master/SensorThings API v1.0.postman_collection.json' and press 'Import'
